...
def xj_proxy_convert(data, target) -> Union[dict, str]:
    ...
    api_url = Config.get("proxy_convert_api", "	http://localhost:3001/api/proxy/parse")
    req_data = {
        "data": p_data,
        "client": target
    }
...
def xj_rule_convert(content, target) -> str:
    api_url = Config.get("rule_convert_api", "http://localhost:3001/api/rule/parse")
    req_data = {
        "data": content,
        "client": target
    }
...
if __name__ == "__main__":
    ...
    demo_c = {"name": "Lv3 香港 01 [2.0]", "type": "ss", "server": "v3-hk.kunlun-sd.com", "port": "6601",
              "cipher": "aes-128-gcm", "password": "e17e96b3-88a9-42c6-87c7-20e89854ac2f"}
